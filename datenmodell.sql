...
-- -----------------------------------------------------
-- Table `proftex`.`Room_has_Chapter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proftex`.`Room_has_Chapter` ;

CREATE TABLE IF NOT EXISTS `proftex`.`Room_has_Chapter` (
  `Chapter_ID` INT NOT NULL,
  `Room_ID` INT NOT NULL,
  PRIMARY KEY (`Chapter_ID`, `Room_ID`),
  INDEX `fk_Chapter_has_Room_Room1_idx` (`Room_ID` ASC),
  INDEX `fk_Chapter_has_Room_Chapter1_idx` (`Chapter_ID` ASC),
  CONSTRAINT `fk_Chapter_has_Room_Chapter1`
    FOREIGN KEY (`Chapter_ID`)
    REFERENCES `proftex`.`Chapter` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Chapter_has_Room_Room1`
    FOREIGN KEY (`Room_ID`)
    REFERENCES `proftex`.`Room` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
